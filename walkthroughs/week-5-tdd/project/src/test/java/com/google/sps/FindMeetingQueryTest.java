...
public final class FindMeetingQueryTest {
    ...
    public void everyRequiredAttendeeConsideredReturnsRequiredSchedule() {
        ...
        Event allDayEvent = new Event("Event 1", 
            TimeRange.fromStartDuration(TimeRange.START_OF_DAY, TimeRange.END_OF_DAY), Arrays.asList(PERSON_C));
    ...
    public void optionalAttendeeBusyReturnsScheduleForOptionalAndRequired() {
        ...
        Event personCEvent = new Event("Event 3",
            TimeRange.fromStartDuration(TIME_0830AM, DURATION_30_MINUTES), Arrays.asList(PERSON_C));
    ...
    public void optionalAttendeeIsIgnoredReturnsRequiredSchedule() {
        ...
        Event personBEvent = new Event("Event 3",
            TimeRange.fromStartDuration(TIME_0830AM, 15), Arrays.asList(PERSON_B));
    ...
    public void queryForOptionalAttendeesReturnsNoAvailability() {
        ...
        Event allDayEventPersonB = new Event("Event 2", 
            TimeRange.fromStartDuration(TimeRange.START_OF_DAY, TimeRange.END_OF_DAY), Arrays.asList(PERSON_B));

        Collection <Event> events = Arrays.asList(allDayEventPersonA, allDayEventPersonB);
